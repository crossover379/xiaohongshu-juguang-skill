...
from xiaohongshu_expert_knowledge_advanced import get_advanced_diagnosis, format_advanced_diagnosis
...
class AIOperationsAssistant:
    ...
    def _load_thresholds(self):
        try:
            with open('/root/.openclaw/workspace/alert_thresholds.json', 'r') as f:
    ...
    def save_thresholds(self, thresholds):
        ...
        with open('/root/.openclaw/workspace/alert_thresholds.json', 'w') as f:
...
告诉我你想做什么，或者直接说需求~"""
    ...
    def generate_push_content(self, template_key, date=None):
        ...
        if template_key == 'daily_report':
            ...
            return self._hasattr_push_content(template_key, date)
        elif template_key == 'cost_alert':
            return self._generate_cost_push(date)
        elif template_key == 'zombie_alert':
            return self._generate_zombie_push()
